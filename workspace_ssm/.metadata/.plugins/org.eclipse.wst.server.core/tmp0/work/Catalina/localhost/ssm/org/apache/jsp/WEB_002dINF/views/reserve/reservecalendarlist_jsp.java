 ...
 * Generated at: 2024-04-12 07:07:50 UTC
...
public final class reservecalendarlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<link rel=\"stylesheet\" href=\"/ssm/resources/css/bootstrap-4.4.1-dist/css/bootstrap.min.css\" />\r\n");
      out.write("<script type=\"text/javascript\" src=\"/ssm/resources/css/bootstrap-4.4.1-dist/js/bootstrap.bundle.min.js\"></script>\r\n");
      out.write("\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#dialog .input-field {\r\n");
      out.write("  padding-left: 3px;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#dialog .textarea-field {\r\n");
      out.write("  padding-left: 3px;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("	/* height: 120px; */ /* 2024.04.07 modify */\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("/* modal title (일정관리) */\r\n");
      out.write("span#ui-id-1 {\r\n");
      out.write("    font-size: 14px;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#dialog #textareameno label {\r\n");
      out.write("  float: left; /* label을 왼쪽으로 띄웁니다. */\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#dialog #textareameno textarea {\r\n");
      ...
      out.write("		width : \"515\", // dialog 넓이 지정\r\n");
      out.write("		/* height: \"470\" */// dialog 높이 지정\r\n");
      out.write("		height : \"380\" // dialog 높이 지정\r\n");
      out.write("	};\r\n");
      out.write("\r\n");
      out.write("	//=========================================== function ===========================================\r\n");
      ...
      out.write("					rsrvdate = arg.extendedProps.rsrvdate;\r\n");
      out.write("				}\r\n");
      out.write("				\r\n");
      out.write("				/// 추가(2024.04.05)\r\n");
      out.write("				//// 예약자명\r\n");
      ...
      out.write("			rObj.rsrvdate  = rsrvdate;\r\n");
      ...
      out.write("\r\n");
      out.write("			$(\"form#diaForm\").find(\"input[name='rsrvDate']\").val(xobj.start.substring(0, 10)); //// 예약일자\r\n");
      out.write("			\r\n");
      out.write("		},\r\n");
      ...
      out.write("		\r\n");
      out.write("		//// 필수 입력 사항 check..\r\n");
      out.write("		if ($obj.rsrvName == \"\" || $obj.rsrvName == \"undefined\" || $obj.rsrvName == null) {\r\n");
      out.write("			alert(\"예약자명을 입력하세요.\");\r\n");
      out.write("			return false;\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		if ($obj.rsrvTelno == \"\" || $obj.rsrvTelno == \"undefined\" || $obj.rsrvTelno == null) {\r\n");
      out.write("			alert(\"연락처를 입력하세요.\");\r\n");
      out.write("			return false;\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		if ($obj.rsrvTime == \"\" || $obj.rsrvTime == \"undefined\" || $obj.rsrvTime == null) {\r\n");
      out.write("			alert(\"시간을 입력하세요.\");\r\n");
      out.write("			return false;\r\n");
      out.write("		}\r\n");
      out.write("\r\n");
      out.write("		//// 시간 : 문자열 길이 체크\r\n");
      out.write("		var time_length_chk = $obj.rsrvTime.replace(/:/g, '');\r\n");
      out.write("		if (time_length_chk.length < 4) {\r\n");
      out.write("			alert(\"시간은 숫자 4자리를 입력하세요.\");\r\n");
      out.write("			return false;\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		if ($obj.rsrvSubject == \"\" || $obj.rsrvSubject == \"undefined\" || $obj.rsrvSubject == null) {\r\n");
      ...
      out.write("	}\r\n");
      out.write("\r\n");
      out.write("	//// 핸드폰번호 유효성 체크\r\n");
      out.write("    $(function() {\r\n");
      out.write("        $(\"#rsrvTelno\").blur(function() {\r\n");
      out.write("            // 입력된 전화번호 가져오기\r\n");
      out.write("            var phoneNumber = $(\"#rsrvTelno\").val();\r\n");
      out.write("            if(phoneNumber) {\r\n");
      out.write("                // 정규식을 사용하여 형식 검사\r\n");
      out.write("                var regex = /^(01[0-9]{1}-?[0-9]{4}-?[0-9]{4}|01[0-9]{8})$/;\r\n");
      out.write("\r\n");
      out.write("                if (regex.test(phoneNumber)) {\r\n");
      out.write("                    // 올바른 형식일 경우\r\n");
      out.write("                } else {\r\n");
      out.write("                    // 잘못된 형식일 경우\r\n");
      out.write("                    alert(\"잘못된 형식의 전화번호 입니다.\");\r\n");
      out.write("                    $(\"#rsrvTelno\").val(\"\");\r\n");
      out.write("                    this.focus();\r\n");
      out.write("                    return false;\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                var pcs = phoneNumber;\r\n");
      out.write("\r\n");
      out.write("                // 입력된 문자열에서 하이픈('-')을 제거하여 숫자만 추출\r\n");
      out.write("                var pcs = pcs.replace(/[^0-9]/g, '');\r\n");
      out.write("\r\n");
      out.write("                // 전화번호 형식 (010-1234-5678)으로 변환\r\n");
      out.write("                if (pcs.length === 10) {\r\n");
      out.write("                    pcs = pcs.substring(0, 3) + '-' + pcs.substring(3, 7) + '-' + pcs.substring(7, 11);\r\n");
      out.write("                } else if (pcs.length === 11) {\r\n");
      out.write("                    pcs = pcs.substring(0, 3) + '-' + pcs.substring(3, 7) + '-' + pcs.substring(7, 11);\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                $(\"#rsrvTelno\").val(pcs);\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("        \r\n");
      out.write("        //// 시간\r\n");
      out.write("        $(\"#rsrvTime\").blur(function() {\r\n");
      out.write("            // 입력된 전화번호 가져오기\r\n");
      out.write("            var reserveTime = $(\"#rsrvTime\").val();\r\n");
      out.write("            \r\n");
      out.write("            if (reserveTime) {\r\n");
      out.write("                // 정규식을 사용하여 형식 검사\r\n");
      out.write("                var regex = /^(?:[01]?[0-9]|2[0-3])(?::?[0-5]?[0-9])?$/;\r\n");
      out.write("\r\n");
      out.write("                if (regex.test(reserveTime)) {\r\n");
      out.write("                    // 올바른 형식일 경우\r\n");
      out.write("                } else {\r\n");
      out.write("                    // 잘못된 형식일 경우\r\n");
      out.write("                    alert(\"잘못된 형식의 시간 입니다.\");\r\n");
      out.write("                    $(\"#rsrvTime\").val(\"\");\r\n");
      out.write("                    this.focus();\r\n");
      out.write("                    return false;\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                var timecnv = reserveTime;\r\n");
      out.write("\r\n");
      out.write("                // 입력된 문자열에서 하이픈(':')을 제거하여 숫자만 추출\r\n");
      out.write("                var timecnv = timecnv.replace(/[^0-9]/g, '');\r\n");
      out.write("\r\n");
      out.write("				// 시간 형식 (09:00)으로 변환\r\n");
      out.write("                if (timecnv.length === 3) {\r\n");
      out.write("					timecnv = timecnv.substring(0, 2) + ':' + timecnv.substring(2, 4);\r\n");
      out.write("                } else if (timecnv.length === 4) {\r\n");
      out.write("                    timecnv = timecnv.substring(0, 2) + ':' + timecnv.substring(2, 4);\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                $(\"#rsrvTime\").val(timecnv);\r\n");
      out.write("            } else {\r\n");
      out.write("				this.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("            }\r\n");
      ...
      out.write("						result = createClnd(calendar, xObj); //// 저장 클릭시 액션 함수\r\n");
      ...
      out.write("						var result = false;\r\n");
      out.write("						\r\n");
      out.write("						result = updateClnd(calendar, xObj); //// 수정 클릭시 액션 함수\r\n");
      out.write("						\r\n");
      out.write("						if (result == true) {\r\n");
      out.write("							$(this).dialog(\"close\");\r\n");
      out.write("						}\r\n");
      ...
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	//// 입력 모드 설정 함수(2024.04.11)\r\n");
      out.write("	function setLanguage(language) {\r\n");
      out.write("	    if (language === 'ko') {\r\n");
      out.write("	        document.getElementById(\"rsrvName\").lang = \"ko\"; //// 한글 입력 모드로 설정\r\n");
      out.write("	    } else if (language === 'en') {\r\n");
      out.write("	        ////document.getElementById(\"email\").lang = \"en\"; //// 영문 입력 모드로 설정\r\n");
      out.write("	    }\r\n");
      out.write("	}\r\n");
      out.write("</script>\r\n");
      out.write("<title>RERVATION-Calendar</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	");
      ...
      out.write("								</div>\r\n");
      out.write("								<div>\r\n");
      out.write("									<label for=\"rsrvDate\" style=\"width: 80px;\">예약일자</label> \r\n");
      out.write("									<input type=\"text\" name=\"rsrvDate\" id=\"rsrvDate\" class=\"input-field\" readonly=\"readonly\" disabled style=\"border:none;\"/>\r\n");
      out.write("								</div>\r\n");
      out.write("								<div>\r\n");
      out.write("									<label for=\"rsrvName\" style=\"width: 80px;\">예약자명</label>\r\n");
      out.write("									<input type=\"text\" name=\"rsrvName\" id=\"rsrvName\" class=\"input-field\" maxlength=\"10\" required onfocus=\"setLanguage('ko')\"> <!-- 한글 입력 모드로 설정 -->\r\n");
      out.write("								</div>\r\n");
      out.write("								<div>\r\n");
      out.write("									<label for=\"rsrvTelno\" style=\"width: 80px\">연락처</label>\r\n");
      out.write("									<input type=\"text\" name=\"rsrvTelno\" id=\"rsrvTelno\" class=\"input-field\" maxlength=\"13\" placeholder=\"010-1234-5678\" />\r\n");
      out.write("								</div>\r\n");
      out.write("								<div>\r\n");
      out.write("									<label for=\"rsrvTime\" style=\"width: 80px;\">예약시간</label>\r\n");
      out.write("									<input type=\"text\"   name=\"rsrvTime\" id=\"rsrvTime\" class=\"input-field\" maxlength=\"5\" placeholder=\"10:00\" />\r\n");
      out.write("								</div>\r\n");
      out.write("								<div>\r\n");
      out.write("									<label for=\"rsrvInwon\" style=\"width: 80px\">인원</label>\r\n");
      out.write("									<input type=\"number\" name=\"rsrvInwon\" id=\"rsrvInwon\" class=\"input-field\" min=\"1\" max=\"10\" />\r\n");
      out.write("									<script type=\"text/javascript\">\r\n");
      out.write("										document.getElementById(\"rsrvInwon\").addEventListener(\"input\", function() {\r\n");
      out.write("										    var maxDigits = 2; //// 최대 입력 길이\r\n");
      out.write("										    if (this.value.length > maxDigits) {\r\n");
      out.write("										        this.value = this.value.substring(0, maxDigits); //// 최대 길이를 초과하는 경우 입력을 제한합니다.\r\n");
      out.write("										    }\r\n");
      out.write("										});\r\n");
      out.write("									</script>\r\n");
      out.write("								</div>\r\n");
      out.write("								<div>\r\n");
      out.write("									<label for=\"rsrvSubject\" style=\"width: 80px\">제목</label>\r\n");
      out.write("									<input type=\"text\" name=\"rsrvSubject\" id=\"rsrvSubject\" class=\"input-field\" maxlength=\"20\" />\r\n");
      out.write("								</div>\r\n");
      out.write("								<div id=\"textareameno\">\r\n");
      out.write("									<label for=\"rsrvMemo\">메모</label>\r\n");
      out.write("									<textarea name=\"rsrvMemo\" id=\"rsrvMemo\" class=\"textarea-field\" rows=\"4\" cols=\"50\" maxlength=\"50\" onfocus=\"setLanguage('ko')\"></textarea>\r\n");
      out.write("								</div>\r\n");
      out.write("								<div>\r\n");
      out.write("									<label for=\"xwriteDate\" style=\"width: 80px;\">작성일자</label>\r\n");
      out.write("									<input type=\"text\" name=\"xwriteDate\" id=\"xwriteDate\" class=\"input-field\"  style=\"border:none;\"/>\r\n");
      out.write("								</div>\r\n");
      out.write("							</form>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
  ...
  private boolean _jspx_meth_c_005fimport_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/reserve/reservecalendarlist.jsp(966,1) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
